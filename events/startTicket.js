    ...
    async execute(interaction) {
        ...
        if (interaction.isButton() && interaction.customId === "start_ticket") {
            ...
            const title = new Discord.TextInputBuilder()
                ...
                .setMaxLength(150)
                .setStyle(1)
                .setPlaceholder('Compras, dúvidas ou suporte');

            const description = new Discord.TextInputBuilder()
                .setCustomId('description')
                .setLabel('Se possível descreva')
                .setRequired(false)
                .setMaxLength(255)
                .setStyle(2)
                .setPlaceholder('...');
            ...
            channel.send({
                ...
                embeds: [
                    new Discord.EmbedBuilder()
                        ...
                        .setDescription(`> **👋 Olá <@${interaction.user.id}>, em instantes estaremos retornando, não marque nossa equipe STAFF, caso queira descrever detalhes sobre abertura do ticket.**\n`)
                        .addFields(
